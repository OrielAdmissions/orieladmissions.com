...
support our future endeavors, please consider [sponsoring Roots](https://github.com/sponsors/roots).
...
- Harness the power of [Laravel](https://laravel.com) and its available packages thanks
  to [Acorn](https://github.com/roots/acorn)
...
# The Roots Sage documentation is super outdated and they've moved away from Bud in favor of Vite

# Get Images or other assets like this:

<code>
{{ Vite::asset('resources/images/college-logos/harvard-business-white-bg.png') }}
</code>
