...
<div class="bg-chalk breakout">
  <section class="pb-30">
    <div class="grid gap-x-8 md:grid-cols-12">
      ...
      >
        <ul class="pin-content space-y-2 max-md:hidden">
          @foreach ($colleges as $college)
            @php $id = Str::kebab($college->post_title); @endphp
            <li>
      ...
      <!-- College Cards -->
      <div class="md:border-keyline/80 long-content insight-cards__container space-y-8 md:col-span-9 md:border-t md:pt-10">
        @foreach ($colleges as $college)
          @php
