@php
  ...
  $onFaqPage = is_page('faqs');
@endphp

<section class="faq-section py-20">
  <div class="grid grid-cols-12 place-content-center content-center gap-x-4 gap-y-20">
    <div @class([
        'md:col-span-4 lg:col-span-3 col-span-full lg:col-start-2' => $onFaqPage,
        'md:col-span-6 lg:col-span-5 col-span-full lg:col-start-2' => ! $onFaqPage,
    ])>
      <div class="pin-content">
        ...
        @if($link)
          <a href="{{ $link }}" target="{!! '_self' !!}" class="btn btn-primary mb-10"> View all FAQs </a>
        @endif
    ...
    <div @class([
        'long-content md:col-span-8 lg:col-span-7 col-span-full' => $onFaqPage,
        'long-content md:col-span-6 lg:col-span-5 col-span-full' => ! $onFaqPage,
    ])>
      @if ($faqs)
        @foreach ($faqs as $faq)
