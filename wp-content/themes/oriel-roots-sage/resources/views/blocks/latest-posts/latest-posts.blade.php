  ...
  <div class="alignnone grid grid-cols-1 gap-8">
          ...
          <div class="swiper-wrapper">
            @while ($latest_query->have_posts())
              ...
              <div class="swiper-slide !h-auto md:max-w-[400px] md:grow">
                <x-post-card :title="get_the_title()" :content="get_the_excerpt()"
                             :button_link="get_the_permalink()"></x-post-card>
              </div>
            @endwhile
          </div>
        </div>
        <div class="relative mx-auto flex w-36">
          <div class="swiper-pagination-4 text-white" style="--swiper-theme-color: var(--color-black)"></div>
        </div>
      @endif
    ...
    <div class="col-start-1 max-sm:hidden md:row-start-1">
      ...
      <div class="relative flex items-center justify-end gap-x-4">
        ...
        <x-button-round direction="left" classes="swiper-button-prev--chevron"></x-button-round>
        <x-button-round classes="swiper-button-next--chevron"></x-button-round>
      </div>
