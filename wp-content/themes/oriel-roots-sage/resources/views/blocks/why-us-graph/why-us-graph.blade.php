<div class="bg-sand !block pt-30">
  <div class="md:the-stack">
    <div class="">
      <div class="alignwide max-w-175">
  ...
  <div class="">
    <div class="alignwide">
      ...
      <div x-data="counter()" x-init="init()" data-percentage="{{ $percentage }}" data-students="{{ $students }}"
           class="grid grid-cols-[repeat(auto-fit,minmax(min(400px,100%),1fr))] gap-4">
        <div class="bg-chalk space-y-6 rounded-lg p-6 text-center shadow-md">
          ...
          @if ($card1_description = get_field('card1_description'))
            <div class="text-lg lg:text-xl">{!! $card1_description !!}</div>
          @endif
        </div>
        ...
        <div class="bg-chalk space-y-6 rounded-lg p-6 text-center shadow-md">
          ...
          @if ($card2_description = get_field('card2_description'))
            <div class="mx-auto max-w-sm text-lg lg:text-xl">{!! $card2_description !!}</div>
          @endif
        </div>
      </div>
